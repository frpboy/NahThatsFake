...
async function checkVirusTotal(url: string): Promise<{
  ...
  try {
    ...
    // ⚡ Bolt Optimization: Replaced base64 encode + string replacements with native base64url encoding
    // This provides a significant speedup and creates less GC garbage for frequent URL processing.
