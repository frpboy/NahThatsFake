...
## 2024-06-12 - Consolidate screen reader announcements for complex list items
**Learning:** Fragmented screen reader readouts on complex interactive cards/list items built with vanilla JS reduce accessibility.
