...
## 2024-05-23 - Consolidate screen reader announcements for complex interactive list items
**Learning:** Screen readers announce complex list items in a fragmented way, reading each element individually. We can improve this by setting a descriptive `aria-label` on the parent container and `aria-hidden="true"` on the child structural elements.
**Action:** Apply this pattern to any complex list items or cards across the app.
